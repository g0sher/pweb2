...
* Architecture du website:
    ...
    * Organisation en Templates (pages) séparés, avec des compléments dans chaque page:
    * Exemple: L'archive "comp-xat.php" peut être facilement inclus sur la page evenements en ajoutant uniquement la règle de php 'include' sur le fichier evenement.php
    
* Avancement jusqu'à ce jour:
        CSS et HTML finis, il y a quelques petites retouches encore à faire et qui seront améliorés dans les futurs TPs.

* Ce qui manque:
        Un housekeeping afin de pouvoir créer un événement (PAS MAINTENANT CAR BESOIN D'URILISER DU PHP)
        Changemenet de Langue (PAS MAINTENANT CAR BESOIN D'UTILISER DU JAVASCRIPT)

* CE QUI MANQUE SERA FAIT AUX FUTURS TPs CAR PAS DÉMANDÉS ENCORE :-> UTILISATION OBLIGATOIRE DE CES LAGAGES ET QUI NE SONT PAS DANS LES CONSIGNES DU TP1, TP2, TP3,
